...
Funcionalidade: Validações do Formulário de Cadastro
  ...
  Cenario: Tentar cadastrar com um valor negativo no campo Salário
    Quando eu tento realizar um cadastro com um salário negativo
    Então o formulário não deve ser submetido e o campo de salário deve indicar um erro
